class AirbalticFlightSearch < ApplicationRecord
  belongs_to :user
  belongs_to :airbaltic_destination
  has_many :price_histories, class_name: "AirbalticPriceHistory", dependent: :destroy
