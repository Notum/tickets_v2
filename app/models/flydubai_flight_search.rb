class FlydubaiFlightSearch < ApplicationRecord
  belongs_to :user
  has_many :price_histories, class_name: "FlydubaiPriceHistory", dependent: :destroy
  ...
  # Hardcoded route: RIX (Riga) to DXB (Dubai)
  ORIGIN = "RIX".freeze
  DESTINATION = "DXB".freeze
  ROUTE_NAME = "Riga to Dubai".freeze
